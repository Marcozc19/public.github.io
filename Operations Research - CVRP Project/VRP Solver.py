...
def saveFile(data):
    outfile = open('C:/Users/zhuan/Desktop/清华大学/2022毕业论文/输出结果/results_new.csv', 'w', newline='', errors='ignore')
...
def solveVRPTWModel(N,Q,TT,ET,LT,ST,Cost,CAP,K):
    ...
    "时间窗约束"
    model.addConstrs(
        T[i, k] + S[i] + TT[i, j] - (1 - X[i, j, k]) * M <= T[j, k] for i in C for j in C for k in K if i != j)
...
if __name__=='__main__':
    filename1 = "C:/Users/zhuan/Desktop/清华大学/2022毕业论文/数据集/Node.csv"
    filename2 = "C:/Users/zhuan/Desktop/清华大学/2022毕业论文/数据集/Link.csv"
    N,Q,TT,ET,LT,ST,Cost=readCsvFile(filename1, filename2)
